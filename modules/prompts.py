...
PROMPT_TEMPLATES: Dict[str, str] = {
    "strict": (
        ...
        " 2. 如果【已知信息】中包含与用户问题相关的内容,即使不够完整或不够具体,也请基于这些内容进行回答。\n"
        " 3. 如果【已知信息】中完全没有涉及用户问题的任何方面,你必须且只能回复：\"我无法回答您的问题\"。\n"
        " 4. 即使你知道答案,但只要【已知信息】里没有相关内容,就视为不知道。\n"
        " 5. 当【已知信息】包含多个相关子主题时,可以有条理地列举和总结这些信息。\n"
        " 【已知信息】\n"
        " {contents}\n"
        " ----\n"
        " 用户问：\n"
